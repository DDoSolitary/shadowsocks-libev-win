...
api_prefix=https://api.bintray.com/content/ddosolitary/dev-releases/default/default
file_name=shadowsocks-libev-win-$ARCH.tar.gz
$curl -X DELETE $api_prefix/$file_name
$curl -f -T binaries.tar.gz $api_prefix/$file_name
$curl -f -X POST $api_prefix/publish
